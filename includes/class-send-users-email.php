...
class Send_Users_Email {
	 ...
	 *
	 * - Send_Users_Email_Loader. Orchestrates the hooks of the plugin.
	 * - Send_Users_Email_i18n. Defines internationalization functionality.
	 * - Send_Users_Email_Admin. Defines all hooks for the admin area.
	 * - Send_Users_Email_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Send_Users_Email_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Send_Users_Email_Public( $this->get_plugin_name(), $this->get_version() );
