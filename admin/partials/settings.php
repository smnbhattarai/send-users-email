                    ...
                    <form action="javascript:void(0)" id="sue-settings-form" method="post">
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless align-middle">
                                <tr>
                                    <td style="width: 25%">
                                        <label for="logo" class="form-label"><?php echo __( 'Logo URL',
												'send-users-email' ); ?></label>
                                        <div id="logoHelp"
                                             class="form-text"><?php echo __( 'Add email header logo URL here. If left blank, logo will not be used.',
												'send-users-email' ) ?></div>
                                    </td>
                                    <td>
                                        <input type="text" class="form-control" id="logo" name="logo"
                                               value="<?php echo esc_url_raw( $logo ); ?>"
                                               placeholder="<?php echo __( 'Add your logo URL',
											       'send-users-email' ); ?>"
                                ...
                                <tr>
                                    <td>
                                        <label for="title" class="form-label"><?php echo __( 'Email Title',
												'send-users-email' ); ?></label>
                                        <div id="titleHelp"
                                             class="form-text"><?php echo __( 'This value will be shown below logo image.',
												'send-users-email' ) ?></div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <label for="tagline" class="form-label"><?php echo __( 'Email Tagline',
												'send-users-email' ); ?></label>
                                        <div id="taglineHelp"
                                             class="form-text"><?php echo __( 'This value will be shown below email title image.',
												'send-users-email' ) ?></div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <label for="footer" class="form-label"><?php echo __( 'Email Footer',
												'send-users-email' ); ?></label>
                                        <div id="footerHelp"
                                             class="form-text"><?php echo __( 'Email footer content will be added to all emails at footer part of email.',
												'send-users-email' ) ?></div>
                                    </td>
                                    <td>
                                        <input type="text" class="form-control" id="footer" name="footer"
                                               value="<?php echo esc_attr( $footer ); ?>"
                                               placeholder="<?php echo __( 'Email footer content',
											       'send-users-email' ); ?>"
                                ...
                                <tr>
                                    <td>
                                        <label for="email_from_name"
                                               class="form-label"><?php echo __( 'Email From/Reply-To Name',
												'send-users-email' ); ?></label>
                                        <div id="emailFromNameHelp"
                                             class="form-text"><?php echo __( 'Email from/reply-to name to use in send emails.',
												'send-users-email' ) ?></div>
                                    </td>
                                    <td>
                                        <input type="text" class="form-control" id="email_from_name"
                                               ...
                                               placeholder="<?php echo __( 'Email from Name', 'send-users-email' ); ?>"
                                ...
                                <tr>
                                    <td>
                                        <label for="email_from_address"
                                               class="form-label"><?php echo __( 'Email From Address',
												'send-users-email' ); ?></label>
                                        <div id="emailFromAddressHelp"
                                             class="form-text"><?php echo __( 'Email from address to use in send emails.',
												'send-users-email' ) ?></div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <label for="reply_to_address"
                                               class="form-label"><?php echo __( 'Reply To Address',
												'send-users-email' ); ?></label>
                                        <div id="replyToAddressHelp"
                                             class="form-text"><?php echo __( 'Reply To address to use.',
												'send-users-email' ) ?></div>
                                    </td>
                                    <td>
